...
EN = {
    ...
    "上传方式": "Upload layout",
    "单图上传": "Single photo",
    "双图 · 左右依次拖入": "Two photos · sequential",
    "双图 · 左右同时进入": "Two photos · simultaneous",
    "双图 · 同框先后替换": "Two photos · replace in one frame",
    "选择第二张照片…": "Choose second photo…",
    "或把第二张照片拖到这里": "or drop the second photo here",
    "支持单图上传，以及双图左右依次拖入、左右同时进入、同框先后替换。双图动作完成后再播放 Fotor 转场；可选一张 AI 结果图，转场时合并展示结果。双图建议使用 3–5 秒，避免动作太快。": "Choose one photo or two: sequential, simultaneous, or replace in one frame. The Fotor transition starts after both uploads. An optional result image replaces the composition. For two photos, allow 3–5 seconds.",
    # —— 导航 / 通用 ——
    ...
    "无杆·匀速滑动": "Clean · linear reveal",
    "两张图保持原位，分界匀速滑过全幅，无白线和手柄；前 72% 揭示 After，后 28% 停留。复刻参考视频请选择从左往右，顶部字幕及 Before/After 标签留空。": "Images stay fixed as a clean edge moves at constant speed: reveal After over the first 72%, then hold for 28%. To match the reference, choose left to right and leave the caption and Before/After labels blank.",
    ...
    "快捷入口": "Shortcuts",
    "角标样式": "Sticker style", "照片卡片＋": "Photo card +",
    "卡片宽度": "Card width", "选择角标原图": "Choose a sticker photo",
    "任意比例都行，按所选样式裁切": "Any aspect ratio; cropped to the selected style",
    ...
    "Fotor 视频模板": "Fotor Video Templates",
    "Fotor 视频生成": "Fotor Video Generator",
    "Fotor 图片生成": "Fotor Image Generator",
    "创意营销内容模板": "Creative Marketing Templates",
    "AI创意库": "AI Inspiration Library",
    ...
    "添加广告投放结尾": "Add ad ending",
    "将最后一帧定格，叠加内置 Fotor 透明结尾及原声，成片增加约 2.9 秒。": "Freeze the last frame and overlay the bundled Fotor ending with its audio. Adds about 2.9 seconds.",
    "标题竖直位置": "Title height",
